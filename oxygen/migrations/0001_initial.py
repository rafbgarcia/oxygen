# Generated by Django 4.0.4 on 2022-07-03 00:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connector', models.CharField(default='mysql', max_length=30)),
                ('x', models.SmallIntegerField(default=0)),
                ('y', models.SmallIntegerField(default=0)),
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tables', to='oxygen.dataset')),
            ],
        ),
        migrations.CreateModel(
            name='Widget',
            fields=[
                ...
                ('dashboard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='widgets', to='oxygen.dashboard')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('table', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='columns', to='oxygen.datasettable')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='relations', to='oxygen.dataset')),
            ],
        ),
        migrations.AddField(
            model_name='dashboard',
            name='dataset',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dashboards', to='oxygen.dataset'),
        ),
    ]
